...
public class Flower {
	...
	@ManyToMany
	@JoinTable(name = "flower_country", joinColumns = @JoinColumn(name = "id_country"), inverseJoinColumns = @JoinColumn(name = "flover_id"))
	...
	@ManyToMany
	@JoinTable(name = "orders_flower", joinColumns = @JoinColumn(name = "id_orders"), inverseJoinColumns = @JoinColumn(name = "id_flover"))
